"""SlyTrade v0.9.15.17 CLI — ICT/SMC scalping bot (Layers 0-5 + live scalper)."""
...
app = typer.Typer(help="SlyTrade ICT/SMC scalper v0.9.15.17")
console = Console()
...
def live_cmd(
    ...
    console.print(f"[bold]SlyTrade LIVE v0.9.15.17[/bold] symbol={raw_symbol} live={live} "
